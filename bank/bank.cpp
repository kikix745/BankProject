...
void OptionTransaction(int read_number){
    switch (read_number)
    {
    case 1:
    Deposit();    
...
void Transactions(){
    cout<<"choose your transaction option"<<endl;
    cout<<"[1] Deposit"<<endl;
    cout<<"[2] Withdraw"<<endl;
    cout<<"[3] Total balance "<<endl;
    cout<<"[4] Main Menu"<<endl;
    OptionTransaction(read_number());
...
void TotalBalances(){
    ...
    cout <<"====================="<<endl;
    cout <<"The total balance is "<<Total_Balances<<endl;
    cout <<"====================="<<endl;
    system("pause");
    Transactions();
